...
%  --------- trayectoria obtenida como referencia
...
subplot(3,1,3)
plot(t_real_total, Varepsilon_real_total, "LineWidth",2)
...
yline(Par_PDF.Thres_Variation, "k--", ...
...
layout30h.TileSpacing = 'compact';
layout30h.Padding = 'compact';
...
set(findall(fig31h,'-property','Interpreter'),'Interpreter','latex') 
